...
import com.name.ungdung.BuildConfig;
import com.name.ungdung.Activity.LoaiSpActivity;
import com.name.ungdung.R;
import com.name.ungdung.ViewModel.AuthViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInGoogle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClassName(BuildConfig.APPLICATION_ID,"com.name.thanhtoan.GoogleSignInActivity");
        ...
        signInFacebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClassName(BuildConfig.APPLICATION_ID,"com.name.thanhtoan.FacebookSignInActivity");
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
